	...
	public static WebDriver getBrowser(String type) {
		if (type.equalsIgnoreCase("Chrome")) {
			...
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\Admin\\eclipse-workspace\\Maven_Projects\\Drive\\chromedriver.exe");
...
//		Robot
	...
	//		Drop down 
	public static void dropdownselect(WebElement element, String selecttype, String value) {
		...
		} else if (selecttype.equalsIgnoreCase("byvisibiletext")) {
			s.selectByVisibleText(value);
		}
	}

	public static void dropdowndeselect(WebElement element, String selecttype, String value) {
	...
	public static void dropdowngetoptions(WebElement element, String gettypes) {
